exports.playResult = (data) => {
  return `ㅤㅤㅤ    ꔷ㆒⸼݇҉ֻ᠂⃟🎵 𝙰𝙺𝙰𝙼𝙴 𝙿𝙻𝙰𝚈 ⸵░⃟🎵\n\n💫⃤ 𝚃í𝚝𝚞𝚕𝚘: ${data.resultado[0].title}\n⏰⃤ 𝚃𝚎𝚖𝚙𝚘: ${data.resultado[0].timestamp}\n👁️⃤ 𝚅𝚒𝚜𝚞𝚊𝚕𝚒𝚣𝚊çõ𝚎𝚜: ${data.resultado[0].views}\n🎞️⃤ 𝙲𝚊𝚗𝚊𝚕: ${data.resultado[0].author.name}\n📹⃤ 𝙿𝚘𝚜𝚝𝚊𝚍𝚘: ${data.resultado[0].ago}\n🔗⃤ 𝚄𝚛𝚕: ${data.resultado[0].url}\n💬⃤ 𝙳𝚎𝚜𝚌𝚛𝚒çã𝚘: ${data.resultado[0].description}`
}
...
return `• ${tempo} *@${sender.split("@")[0]}*, o comando usado não foi encontrado!\n• Utilize *${prefix}menu* para visualizar meus comandos.`
}
