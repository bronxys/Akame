...
╰╦══════════════════ ⪨
╭┤き⃟👤 𝐍𝐎𝐕𝐎𝐒 𝐌𝐄𝐍𝐔𝐒 👤⃟ き
┃│➥ ${prefix}lojinha「 _ALUGAR BOT_ 」
┃│➥ ${prefix}Menudono 「 _MENU CEO_ 」
┃│➥ ${prefix}Menuadm 「 _MENU ADM_ 」
┃│➥ ${prefix}Menupremium「 _VIP_ 」
┃│➥ ${prefix}Efeitosimg「 _EFEITOS IMG_ 」
┃│➥ ${prefix}alteradores 「 _ALTERAÇÃO_ 」
┃│➥ ${prefix}Logos 「 _MENU LOGOS_ 」
┃│➥ ${prefix}menu18 「 _PORNO HENTAI_ 」
┃│➥ ${prefix}Brincadeiras 「 _BRINKS_ 」
┃│➥ ${prefix}Animes 「 _MENU ANIME_ 」
┃╰══ ⪨
╰╦══════════════════ ⪨
╭┤き⃟👥 𝐌𝐄𝐍𝐔 𝐌𝐄𝐌𝐁𝐑𝐎𝐒 👥⃟ き
┃│➥ ${prefix}pv (envia no privado)
...
┃│➥ ${prefix}Banghost
┃│➥ ${prefix}Listafake (números fake do grupo)
┃│➥ ${prefix}Listabr (números BR do grupo)
┃│➥ ${prefix}Banfake (ban todos os fake do grupo)
┃│➥ ${prefix}grp 1m (grupo e abrir após um minuto)
...
┃│➥ ${prefix}plaq4  (texto)
┃│➥ ${prefix}plaq5  (texto)
┃│➥ ${prefix}pornovid  (videos) 
┃│➥ ${prefix}ahegao  (imagem) 
┃│➥ ${prefix}ass  (imagem) 
┃│➥ ${prefix}bdsm  (imagem) 
┃│➥ ${prefix}blowjob  (imagem) 
┃│➥ ${prefix}cuckold  (imagem) 
┃│➥ ${prefix}cum  (imagem) 
┃│➥ ${prefix}ero  (imagem) 
┃│➥ ${prefix}kasedaiki  (imagem) 
┃│➥ ${prefix}femdom  ( imagem) 
┃│➥ ${prefix}foot  (imagem) 
┃│➥ ${prefix}gangbang  (imagem) 
┃│➥ ${prefix}glasses  (imagem) 
┃│➥ ${prefix}hentai2  (imagem) 
┃│➥ ${prefix}jahy  (imagem) 
┃│➥ ${prefix}manga  (imagem) 
┃│➥ ${prefix}masturbation  (imagem) 
┃│➥ ${prefix}neko  (imagem) 
┃│➥ ${prefix}orgy  (imagem) 
┃│➥ ${prefix}panties  (imagem) 
┃│➥ ${prefix}pussy  (imagem) 
┃│➥ ${prefix}neko2  (imagem) 
┃│➥ ${prefix}thighs  (imagem) 
┃│➥ ${prefix}yuri  (imagem) 
┃╰══ ⪨
╰═══════════════════ ⪨
`;
